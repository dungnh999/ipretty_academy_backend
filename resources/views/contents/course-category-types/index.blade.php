...
@section('content')
          ...
          <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
            ...
            <span class="d-none d-sm-block"> Đang hoạt động
                  <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-primary ms-1"
                        id="totalActiveCourseCategoryTypes">0</span>
              </span>
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-unactive-category-course"
            ...
            <span class="d-none d-sm-block"> Tạm ngưng
                <span class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-primary ms-1"
                      id="totalUnActiveCourseCategoryTypes">0</span>
            </span>
          </button>
        </li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane fade show active" id="navs-active-category-course-types" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-category-course-types-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
              <tr>
                <th class="text-center">STT</th>
                <th class="text-center">Tên Loại Doanh Mục</th>
                <th></th>
              </tr>
              </thead>
            </table>
        ...
        <div class="tab-pane fade" id="navs-unactive-category-course" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-unactive-category-course-types-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
              <tr>
                <th class="text-center">STT</th>
                <th class="text-center">Tên Loại Doanh Mục</th>
  ...
  @include('contents.course-category-types.create')
  @include('contents.course-category-types.update')
@endsection
@push('pricing-script')
  <script src="{{asset('assets/js/category-course-types/index.js')}}"></script>
@endpush
