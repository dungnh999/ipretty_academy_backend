      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="navs-active-category-course-types" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-course-active-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
                <tr>
        ...
        <div class="tab-pane fade" id="navs-unactive-category-course" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-course-unactive-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
                <tr>
                  <th class="text-center">STT</th>
                  <th class="text-center">Tên Khoá học</th>
