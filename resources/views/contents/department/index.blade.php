      ...
      <div class="tab-content">
        <div class="tab-pane fade show active" id="navs-active-department" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-department-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
                <tr>
        ...
        <div class="tab-pane fade" id="navs-unactive-department" role="tabpanel">
          <div class="card-datatable table-responsive">
            <table id="table-unactive-department-ipretty" class="datatables-basic table border-top dataTable no-footer dtr-column">
              <thead>
              <tr>
                <th class="text-center">STT</th>
                <th class="text-center">Tên Bộ Phận</th>
...
@endsection
@push('pricing-script')
  <script src="{{asset('assets/js/department/index.js')}}"></script>
@endpush
