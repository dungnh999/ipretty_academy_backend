...
class CreateSurveyAPIRequest extends APIRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'percent_to_pass' => 'required|integer|between:0,100',
            // 'questions_data' => 'required',
            // 'questions_data.quesions' => 'required',
            // 'questions_data.questions.*.question_title' => 'required',
            // 'questions_data.questions.*.options' => 'required',
            // 'questions_data.questions.*.options.*.option_body' => 'required',
            // 'questions_data.questions.*.options.*.right_answer' => 'required'
            // 'question_per_page' => 'numeric|min:0',
        ];
        // var_dump(isset($this->questions_data) && count($this->questions_data) && !$this->questions_data["questions"]);
    ...
    public function messages()
    {
        return [
            ...
            // 'percent_to_pass.lte' => __('validation.lte', ['attribute' => __('models/surveys.fields.percent_to_passUp')]),
