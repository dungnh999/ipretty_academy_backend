...
class CreateLessonAPIRequest extends APIRequest
{
    ...
    {   
        $max_size = env('MAX_SIZE_FILE_UPLOAD', 5120000);

        $rules = [
            'lesson_name' => 'required',
            'lesson_description' => 'required',
            'lesson_content' => 'required',
//            'main_attachment' => 'required|max:'. $max_size,
            // 'main_attachment' => 'required|mimes:mp4,wmv,avi|max:'. $max_size,
    ...
    {
        return [
            'main_attachment.required' => __('validation.required_file', ['attribute' => __('models/lessons.fields.main_attachment_lowercase')]),
