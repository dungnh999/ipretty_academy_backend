...
class CourseIsClose extends Notification
{
    use Queueable;
    protected $course;
    protected $type_user;
    ...
    public function toArray($notifiable)
    {
        ...
        if($this->type_user == "student") {
            $message = "Khóa học : .".$course_name . " của bạn đã kết thúc.";
        }
        if($this->type_user == "teacher") {
            $message = "Khóa học : .".$course_name . " của bạn đảm nhiệm đã kết thúc.";
        }
        if($this->type_user == "admin") {
            $message = "Khóa học : .".$course_name . " đã kết thúc.";
        }
        return [
            'message' => $message,
